  ...
  return (
    <>
      <div className="w-full bg-lightBackground py-12">
        <Container>
            <div className="border-primary border-solid border-2 rounded-xl p-4
            flex flex-col items-center bg-gray-100">
                <div className="w-full lg:w-5/6 py-4">
                    <h1 className="font-bold text-primary text-2xl text-center lg:text-5xl">მოგვწერე</h1>
              ...
              <div className="grid w-full justify-between sm:flex sm:justify-between md:flex md:grid-cols-1">
                <div className="flex items-center">
                  <FooterFlowbite.Brand
                    ...
                    alt="Flowbite Logo"
                  />
                  <h4 className="font-semibold text-primary">გიას სასტუმრო</h4>
                </div>
